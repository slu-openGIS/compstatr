...
test_that("input error triggered - no dateVar", expect_missing_xy(cs_parse_int( test_data,ILEADSStreet,Intersection1,Intersection2), "The name of the column to be made containing the date information must be specified for dateVar"))
