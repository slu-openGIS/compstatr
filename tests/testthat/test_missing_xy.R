...
test_that("input error triggered - no .data", expect_error(cs_missing_xy( ,XCoord,YCoord,missingXY), "A existing data frame with data to be separated must be specified for .data"))
...
test_that("input error triggered - no varx", expect_error(cs_missing_xy( test_data,XCoord,,missingXY), "The column containing the data to be separated must be specified for vary"))
